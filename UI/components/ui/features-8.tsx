...
import { Shield, Users, TrendingUp, BarChart2, PieChart } from 'lucide-react'
            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 border-white/10 bg-[#0c0f1d] shadow-2xl glass-panel">
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border-white/10 bg-[#0c0f1d] shadow-2xl glass-panel">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-semibold transition text-white">Risk-Adjusted Scores</h2>
                                    <p className="text-white/60">Proprietary grading system based on volatility and Sharpe ratios.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border-white/10 bg-[#0c0f1d] shadow-2xl glass-panel">
                            <CardContent className="pt-6">
                                    ...
                                    <svg className="text-white/20 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-primary" stopOpacity="0.35" stopColor="currentColor" />
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-semibold transition text-white">Real-time Insights</h2>
                                    <p className="text-white/60">Instant filtering across categories, grades, and risk profiles.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 border-white/10 bg-[#0c0f1d] shadow-2xl glass-panel">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                        <BarChart2 className="m-auto size-5 text-white/80" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-semibold text-white transition">Performance Analytics</h2>
                                        <p className="text-white/60">Deep dive into CAGR, Alpha, and consistency metrics.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-lg relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/10 p-6 py-6 sm:ml-6 bg-white/5">
                                    ...
                                    <div className="mt-4 flex gap-2">
                                        <div className="h-20 w-1/3 bg-blue-500/20 rounded border border-blue-500/40"></div>
                                        <div className="h-16 w-1/3 bg-emerald-500/20 rounded border border-emerald-500/40 mt-4"></div>
                                        <div className="h-24 w-1/3 bg-[#F27D26]/20 rounded border border-[#F27D26]/40 -mt-4"></div>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 border-white/10 bg-[#0c0f1d] shadow-2xl glass-panel">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                        <PieChart className="m-auto size-5 text-white/80" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-semibold text-white transition">Smart Allocations</h2>
                                        <p className="text-white/60">Personalized fund recommendations based on your risk appetite.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-lg relative -mb-6 -mr-6 mt-6 border-l border-t border-white/10 p-6 sm:ml-6 bg-white/5">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
